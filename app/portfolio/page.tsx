...
import type { RealizedOutcomeFilter } from '@/components/FilterBar';
...
export default function PortfolioPage() {
  ...
  const filtered = useMemo(() => {
    let result = stocks.filter((s) => {
      ...
      return statusOk && realizedOutcomeOk && typeOk && portOk && yearOk && searchOk;
    });
    ...
    return result;
  }, [stocks, filterStatus, realizedOutcome, filterType, filterPort, filterYear, activeSort, searchQuery]);
